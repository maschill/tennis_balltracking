...
if __name__ == "__main__":
	...
	if args.ballpositions is not None:
		...
		file = os.path.join(os.getcwd(), '../../../data/processed/ballpositions.csv')
		num = format(args.startframe, '05d')
		path = '../../../data/raw/images/3_image_GP_00306.png'
		print(num, path)
	...
	with open('../../../data/processed/pickle_smoothed_ball_position.pkl', 'wb') as file:
		pickle.dump(smballpos, file)
